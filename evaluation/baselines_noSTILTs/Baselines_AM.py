...
def main():
    ...
    x, y_arg, y_rhet = load_conll.load_data(
        path="")  # todo path "\data\Argument_Component_Identification_Lauscher\annotations_conll_all_splitted\train_dev_Thesis")
    x_test, y_arg_test, y_rhet_test = load_conll.load_data(
        path="")  # todo path "\data\Argument_Component_Identification_Lauscher\annotations_conll_all_splitted\test")
