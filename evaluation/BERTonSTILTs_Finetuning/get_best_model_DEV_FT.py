...
def main():
    path = get_path_to_OS() + "/evaluation/BERTonSTILTs_Finetuning/DEV_Scores_Consolidated.txt"
    AZI_bucket = []
    AQ_bucket = []
    AR_GM_bucket = []
    AR_GM_UGIP_bucket = []
...
def _write_best_target_models_Dev_score(best_model_each):
    path = get_path_to_OS() + "/evaluation/BERTonSTILTs_Finetuning/Best_DEV_Score_Targetmodels.txt"
