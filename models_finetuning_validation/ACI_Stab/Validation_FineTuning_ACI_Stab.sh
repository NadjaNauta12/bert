...
if [ "$OS" = "Windows_NT" ] ; then
   echo "Windows_NT"
    ...
    export BERT_finetuning_output_dir="models_finetuning/ACI_Stab"
    export BERT_finetuning_output_dir_VALIDATION="models_finetuning_validation/ACI_Stab"
    export BERT_onSTILTs="models_onSTILTs/models/ACI_Stab_32_5e-05_3/model.ckpt-356"
    # # # # # # # # # #
    ...
    for task_name in  "ArgZoningI" "InsufficientArgSupport" "ArgQuality" ; do # VALIDATION
        echo $task_name
        case $task_name in
...
#
    ...
    echo ">>>>> EVALUATION <<<<<"
#    for task_name in "ArgQuality" "InsufficientArgSupport" "ArgZoningI" "ACI_Lauscher" "ACI_Stab" ; do
...
#    python evaluation/evaluate_predictions_Args.py  \
#         --task="ACI_Stab" \
#         --singleTaskSetting=false
#
