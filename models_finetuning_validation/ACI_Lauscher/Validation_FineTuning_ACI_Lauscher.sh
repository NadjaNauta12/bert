...
if [ "$OS" = "Windows_NT" ] ; then
   echo "Windows_NT"
    ...
    export BERT_finetuning_output_dir_VALIDATION="models_finetuning_validation/ACI_Lauscher"
    export BERT_onSTILTs="models_onSTILTs/models/ACI_Lauscher_32_3e-05_3/model.ckpt-422"
    # # # # # # # # # #
...
#    for task_name in  "ArgZoningI" "InsufficientArgSupport"  ; do # VALIDATON
#        echo $task_name
#        case $task_name in
...
#
    ...
    echo ">>>>> EVALUATION <<<<<"
    for task_name in "ArgZoningI" "InsufficientArgSupport" ; do
