...
if [ "$OS" = "Windows_NT" ] ; then
   echo "Windows_NT"
    ...
    export BERT_finetuning_output_dir_VALIDATION="/models_finetuning_validation/ArgRecognition_GM_UGIP"
    export BERT_onSTILTs="/models_onSTILTs/models/ArgRecognition_8_5e-05_4_GM_UGIP/model.ckpt-449"
    # # # # # # # # # #
...
#    for task_name in   "InsufficientArgSupport" "ArgZoningI" "ACI_Lauscher"  ; do
#        echo $task_name
#        case $task_name in
