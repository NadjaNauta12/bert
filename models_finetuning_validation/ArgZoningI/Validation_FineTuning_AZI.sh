...
if [ "$OS" = "Windows_NT" ] ; then
   echo "Windows_NT"
    ...
    export BERT_finetuning_output_dir_VALIDATION="models_finetuning_validation/ArgZoningI"
    export BERT_onSTILTs="models_onSTILTs/models/ArgZoningI_32_2e-05_3/model.ckpt-554"
    # # # # # # # # # #
...
#     for task_name in   "InsufficientArgSupport"  "ACI_Lauscher" ; do # VALIDATION
#        echo $task_name
#        case $task_name in
...
#    echo ">>>>> Training completed <<<<<"
    ...
    echo ">>>>> EVALUATION <<<<<"
    for task_name in "InsufficientArgSupport"  "ACI_Lauscher" ; do
