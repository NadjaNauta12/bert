...
if [ "$OS" = "Windows_NT" ] ; then
   echo "Windows_NT"
    ...
    export BERT_finetuning_output_dir="models_finetuning/InsufficientArgSupport"
    export BERT_onSTILTs="models_onSTILTs/models/InsufficientArgSupport_32_5e-05_3/model.ckpt-69"
    # # # # # # # # # #
    ...
    for task_name in  "ArgQuality" "ArgZoningI" "ACI_Stab" "ACI_Lauscher"  ; do
        echo $task_name
        case $task_name in
...
#    echo ">>>>> EVALUATION <<<<<"
#    for task_name in "ArgQuality" "ArgZoningI" "InsufficientArgSupport" "ArgRecognition" "ACI_Lauscher"  ; do
