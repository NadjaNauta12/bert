...
def convert_single_example(ex_index, example, label_list, max_seq_length,
    ...
    # TODO entfernen? should not be too long - but just to make sure the cut is made here (again)
...
def model_fn_builder(bert_config, num_labels, label_list, init_checkpoint, learning_rate,       # todo do not need label_list
...
def main_run_classifier(_, config_str, train_batch_size, learning_rate, num_train_epochs):
    ...
    model_fn = model_fn_builder(
        bert_config=bert_config,
        label_list=label_list, # todo not required?
