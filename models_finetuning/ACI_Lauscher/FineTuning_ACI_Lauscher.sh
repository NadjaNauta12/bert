...
if [ "$OS" = "Windows_NT" ] ; then
   echo "Windows_NT"
    ...
    export BERT_finetuning_output_dir="/models_finetuning/ACI_Lauscher"
    export BERT_onSTILTs="/models_onSTILTs/models/ACI_Lauscher_32_2e-05_4/model.ckpt-563"
    # # # # # # # # # #
    ...
    for task_name in  "ArgZoningI" "InsufficientArgSupport" "ArgQuality" "ACI_Stab"  ; do
        echo $task_name
        case $task_name in
...
#    echo ">>>>> EVALUATION <<<<<"
#    for task_name in "ArgQuality" "ArgZoningI" "InsufficientArgSupport" "ArgRecognition" "ACI_Stab"  ; do
