...
if [ "$OS" = "Windows_NT" ] ; then
   echo "Windows_NT"
    ...
    export BERT_finetuning_output_dir="models_finetuning/ArgRecognition_GM"
    export BERT_onSTILTs="models_onSTILTs/models/ArgRecognition_32_2e-05_3_GM/model.ckpt-58"
    # # # # # # # # # #
